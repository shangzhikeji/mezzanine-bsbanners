    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(editable=False, to='sites.Site',on_delete=models.DO_NOTHING)),
            ],
            options={
                'ordering': ['title'],
                'verbose_name': 'Banner',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('banner', models.ForeignKey(to='mezzanine_bsbanners.Banners',on_delete=models.DO_NOTHING)),
            ],
            options={
                'ordering': ['sort_order'],
                'verbose_name': 'Slide',
